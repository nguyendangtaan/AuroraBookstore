    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mt-2 mb-2">
                    <a style="color: #942446; font-size: 1.25rem" class="nav-link d-flex align-items-center gap-2" aria-current="page" href="<?php echo e(route('admin.authors.index')); ?>">
                        <i class="fas fa-dashboard"></i>
                        Author
                    </a>
                </li>
                <li class="nav-item mt-2 mb-2">
                    <a style="color: #942446; font-size: 1.25rem" class="nav-link d-flex align-items-center gap-2" aria-current="page" href="<?php echo e(route('admin.books.index')); ?>">
                        <i class="fas fa-dashboard"></i>
                        Books
                    </a>
                </li>
                ...
                <li class="nav-item mt-2 mb-2">
                    <a style="color: #942446; font-size: 1.25rem"  class="nav-link d-flex align-items-center gap-2" aria-current="page" href="<?php echo e(route('admin.coupons.index')); ?>">
